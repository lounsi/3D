...
public class UIManager : MonoBehaviour
{
    ...
    public GameObject panelDiagnostic;
    ...
    public Button btnShowDiagnostic;
    ...
    void Start()
    {
        ...
        if (btnShowDiagnostic != null)
            btnShowDiagnostic.onClick.AddListener(() => ShowScreen(3));
    ...
    public void ShowScreen(int index)
    {
        ...
        if (panelDiagnostic != null)
            panelDiagnostic.SetActive(index == 3);
        
        string[] names = { "Import", "Traitement", "Visualisation", "Diagnostic IA" };
